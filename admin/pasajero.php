...
<body>
         ...
         <div class="row">
           ...
           <div class="col-md-12">
              ...
              <table class="table table-striped">
                ...
                <tr>
                  <td>
                    <button id="btn-guardar-pasajero" type="button" class="btn btn-success"><span class="glyphicon glyphicon-save"></span> Guardar</button>
                    <button id="btn-actualizar-pasajero" type="button" class="btn btn-info"><span class="glyphicon glyphicon-save"></span>Actualizar</button>
                  </td>
                </tr>
              </table>
            </div>
             <div class="well col-md-12" id="div-pasajeros">
              <table id="tbl-pasajeros" class="table table-striped">
                <thead>
                  <th>Primer Nombre</th>
  ...
  <script type="text/javascript" src="../js/admin-pasajero.js"></script>
</body>
</html>
